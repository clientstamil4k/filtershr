class script(object):   
    ...
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴 : {}
✯ OWNER : <a href=https://t.me/dilli_sir>Dilli</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈 : 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴 : 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴 : 𝙼𝙾𝙽𝙶𝙾-𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁 : HEROKU
✯ 𝙱𝚄𝙸𝙻𝙳 𝚅𝙴𝚁𝚂𝙸𝙾𝙽: JON SNOW 𝚟3.9.11"""

    SEARCH_TXT = """⚠️❗️ 𝗠𝗼𝘃𝗶𝗲 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗙𝗼𝗿𝗺𝗮𝘁 ❗️⚠️
...
❌ [𝗗𝗼𝗻𝘁 𝗨𝘀𝗲 𝘄𝗼𝗿𝗱𝘀 𝗟𝗶𝗸𝗲 𝗗𝘂𝗯𝗯𝗲𝗱/𝗠𝗼𝘃𝗶𝗲𝘀/𝗦𝗲𝗻𝗱/𝗛𝗗 , . : - 𝗲𝘁𝗰] ❌"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 𝙲𝙻𝙸𝙲𝙺 𝙷𝙴𝚁E 👉 :PIAD ONLY @dilli_sir
<b>Channels:</b>
- Main Channel - <a href=https://t.me/shr_pro_bots>Shr Pro Bots</a>
- Movies - <a href=https://t.me/tamilmovrequest>Movie Channel</a>"""
...
<code>/batch https://t.me/firstmessagelink https://t.me/lastmessagelink</code>

<https://t.me/MxA_bots><b>MxA Bots</b></a>"""
...
𝖬𝖺𝖽𝖾 𝖻𝗒 <a href=https://t.me/MxA_Bots>MxA Bots</a>"""
